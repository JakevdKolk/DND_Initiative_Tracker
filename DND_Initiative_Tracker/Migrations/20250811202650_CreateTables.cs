    ...
    public partial class CreateTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                ...
                CREATE INDEX IF NOT EXISTS idx_user_owner_creature ON creature (owner_user_id);
                CREATE INDEX IF NOT EXISTS idx_encounter_death_status ON creature_encounter (death_status);
                CREATE INDEX IF NOT EXISTS idx_damage_type_category ON creature_damage_types (damage_type_category);
                CREATE INDEX IF NOT EXISTS idx_skill_type ON skill (skill_type);
                CREATE INDEX IF NOT EXISTS idx_initiative ON creature_encounter (encounter_id, initiative DESC);");
        ...
        {
            migrationBuilder.Sql(@"
                DROP INDEX IF EXISTS idx_initiative;
                DROP INDEX IF EXISTS idx_skill_type;
                DROP INDEX IF EXISTS idx_damage_type_category;
                DROP INDEX IF EXISTS idx_encounter_death_status;
                DROP INDEX IF EXISTS idx_user_owner_creature;
                DROP INDEX IF EXISTS idx_action_type;

            
                DROP TABLE IF EXISTS creature_action;
                DROP TABLE IF EXISTS spell_action;
                DROP TABLE IF EXISTS action;
                DROP TABLE IF EXISTS spell;

                DROP TABLE IF EXISTS creature_condition;
                DROP TABLE IF EXISTS condition;

                DROP TABLE IF EXISTS creature_skill;
                ...
                DROP TABLE IF EXISTS creature_damage_types;
                DROP TABLE IF EXISTS damage_types;


                DROP TABLE IF EXISTS creature_abillity_scores;
                DROP TABLE IF EXISTS ability_score_type;

                DROP TABLE IF EXISTS creature_speed;
                DROP TABLE IF EXISTS speed;

                DROP TABLE IF EXISTS creature_encounter;
